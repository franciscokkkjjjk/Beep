...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Out-2022 às 00:25
...
(8, 824, 2, 816, 'teste', '', 0, 0, '2022-09-30 15:00:07', 0, NULL),
(8, 722, 1, 461, 'teste', '', 0, 0, '2022-09-28 17:44:32', 0, 0),
(8, 816, 2, 815, 'pqp oia esse cara ', '', 1, 1, '2022-09-28 18:47:52', 0, NULL),
...
(1, 8, 'asdasd', 'ccdee96b58c875705555379e428af9a1ab565f64.png', 'dassda', 'dassad', 'dsffsdfds', 20, '2022-09-30 19:15:26', 1),
(2, 8, 'asdasd', '6bdf41ade61e8156d864d65cd29087676fd85943.png', 'dassda', 'dassad', 'dsffsdfds', 20, '2022-09-30 19:17:25', 1),
(3, 8, 'asdasd', 'af70a7110ebc7c7eb01aac4693273cb99493fe58.png', 'dassad', 'dasdas', 'dasads', 14, '2022-09-30 19:24:25', 1),
(4, 8, 'sadasds', 'ca6259fe7aafb41a3ec862bdd59be8083530a439.png', 'asdasddsa', 'asdsda', 'dasdsa', 0, '2022-09-30 19:24:48', 1);
...
(8, '@fran_pedrinha', 5, 6, 'fran@gmail.com', 'franciscos', '$2y$10$VeknT5KBG5k4yWCoVUo4fu3U2UlfCRnEOdFo7GFroPjxx/bLMTOC2', '62d6d7e37f319.png', '6334bfa08bded.gif', 'gosto de suco de uva | desempregado profissional', '2004-04-09', 1),
...
--
ALTER TABLE `publicacoes`
  MODIFY `id_publi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=828;

--
-- AUTO_INCREMENT de tabela `solicita_list`
--
ALTER TABLE `solicita_list`
  MODIFY `id_solicita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
