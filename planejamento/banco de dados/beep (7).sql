...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Set-2022 às 19:24
...
(9, 461, 3, NULL, 'teste', '', 7, 0, '2022-08-24 15:30:37', 0, 0),
...
(9, 539, 3, NULL, 'kkkkk recem foi ter jogos na rede social de jogos lllllkkkkkk', '', 37, -2, '2022-09-14 18:49:33', 3, 0);
...
(8, '@fran_pedrinha', 5, 6, 'fran@gmail.com', 'franciscos', '$2y$10$VeknT5KBG5k4yWCoVUo4fu3U2UlfCRnEOdFo7GFroPjxx/bLMTOC2', '62d6d7e37f319.png', '63290fdc30105.gif', 'gosto de suco de uva | desempregado profissional', '2004-04-09', 1),
...
--
ALTER TABLE `publicacoes`
  MODIFY `id_publi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=619;
