...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Out-2022 às 00:32
...
(8, 816, 2, 815, 'pqp oia esse cara ', '', 1, 0, '2022-09-28 18:47:52', 0, NULL),
...
(8, 810, 4, 808, NULL, '', 0, 0, '2022-09-28 18:42:39', 0, NULL),
(8, 808, 2, 798, 'esse cara ta doido ', '', 0, 1, '2022-09-28 18:42:24', 0, NULL),
...
(8, '@fran_pedrinha', 6, 7, 'luisfrancisco.15.brum@gmail.com', 'franciscos', '$2y$10$VeknT5KBG5k4yWCoVUo4fu3U2UlfCRnEOdFo7GFroPjxx/bLMTOC2', '633cd2a4e61ac.png', '6334bfa08bded.gif', 'gosto de suco de uva | desempregado profissional', '2004-04-09', 1),
(9, '@mira_narek', 6, 7, 'mira@gmail.com', 'miranda', '$2y$10$G/Um7Dnbp5LqwnfVIJNue.D4YYgWqpWAoJcfdnkSyru/asS7WLkDe', '633cd1827f879.jpg', '62e16edd2f227.jpg', 'gosto de tortas', '2002-05-06', 1),
...
(12, '@pedrinhas', 4, 1, 'pedrinhaskid@gmail.com', 'pedrinhasKid', '$2y$10$63p1jKZOdCUncW/38Y1LN.Z2t2K0OJYzOAjWAvzzLDA1sDn.uDFQS', '', '', '', '2008-01-15', 1),
...
(32, '@ezquzi_15', 2, 0, 'ezquzi_15@gmail.com', 'ezquzi_15', '$2y$10$ho/mf0gqaqbz3jv8u05XBO6HPBlLg.K5bo5DyI12movdlwRau2Xm.', '', '', '', '2005-04-08', 0),
...
(36, '@test211812', 1, 0, 'f@gf', 'teste', '$2y$10$m4QYdnDGaSs/1oBXrxsyPuNHGAsorh6lRKnPOkWFkVkFBFhGvhIwa', NULL, NULL, NULL, '1989-05-27', 0),
...
--
ALTER TABLE `publicacoes`
  MODIFY `id_publi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=873;
